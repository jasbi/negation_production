...
With regards to the domain of theory of mind, we attended to cases that express epistemic position. Specifically, we focused on utterances that articulate the concept of unknowing (*I not know* or *I didn't remember*) or uncertainty (*I don't think so*). The cases that were subject to analyses here included either *know*, *remember* or *think* as the head verb, modified by the negative morphemes or the combination of the negative morphemes with auxiliaries. Additionally, we restricted to instances where the head verb is either subjectless or has the subject *I*. This led to a subset of 27,821 utterances in total (Child: 9,282; Parent: 18,539)

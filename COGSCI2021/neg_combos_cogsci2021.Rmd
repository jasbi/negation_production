...
A fourth function of negation discussed in the literature is "denial". @bloom1970language originally defined it as asserting that "an actual or supposed predication was not the case". For example a child may say: "It's not sharp". Later researchers labeled it as "truth-functional negation" and suggested that it is used to neate the truth of a proposition [@cameron2007part].  

One possibility is that negation develops, and is aided by the act of labeling and categorizing objects and actions for linguistic communication. This function would manifest istelf in labeling acts with nominal predicates such as "this is not a bunny", "not red", or "this isn't a reptile". 

There has been no proposal for negation originating in children's understanding of their own or others' mental states. In fact, most development theory of mind accounts assume that this ability emerges later in children. However, many corpus instances of negation modify mental state verbs such as *know*, *think*, and *remember* (e.g. "I not know").
...
|------|--------|---------|
|Emotion|*like*, *want*|*don't like/want juice*|
|Motor Control|imperatives, *can*|*don't touch it*, *can't do it*|
|Perception||*there's no water*, *no more candy*|
|Word Learning|Predicative Nouns and Adjectives|*that's not a cat*, *this is not red*|
|Theory of Mind|mental state verbs |*I don't know/remember/think-so*|

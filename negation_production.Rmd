...
-->
total utterances: 
- number of children: `r child_utterances$speaker_id %>% unique() %>% length`
- number of utterances: `r nrows(child_utterances)`
- mean age of participants: `r `
negative utterances: 
- number of children: `r child_negation$speaker_id %>% unique() %>% length`
- number of utterances: `r nrows(child_negation)`

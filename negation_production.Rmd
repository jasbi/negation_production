...
To do this, we again used the English-North America and English-UK collections of corpora from CHILDES [@macwhinney2000childes]. Since the current version of childesr [@sanchez2019childes] does not contain annotations of syntactic dependencies, we developed in-house scripts to directly extracted syntactically annotated utterances from the original xml formmated files in CHILDEs, using the programmming language python. This led to a total of 3,987,829 syntactically annotated utterances, with 

...
### Given the above, this is all obselete right now. 
...
# no_proportions <- (no_sums[,-(1:2)] / no_sums[,2]) %>%
...
not_proportions <- (not_sums[,-(1:2)] / not_sums[,2]) %>%
...
mod_proportions <- (mod_sums[,-(1:2)] / mod_sums[,2]) %>%

...
pre_no_tag <- function(pos) {
  if(grepl('^no:\\w+ n v ?.*', pos)) {return("presentential")}
  else if (grepl('n no:\\w+ v ?.*', pos)){return("pre-verb (w/ subject)")}
  else if (grepl('[^n]*no:\\w+ v ?.*', pos)){return("pre-verb (w/o subject)")}
  else if (grepl('no:\\w+ n ?.*', pos)){return("pre-noun")}
  else {return("other")}
}
...
pre_not_tag <- function(pos) {
  if(grepl('^not n v ?.*', pos)) {return("presentential")}
  else if (grepl('n not v ?.*', pos)){return("pre-verb (w/ subject)")}
  else if (grepl('[^n]*not v ?.*', pos)){return("pre-verb (w/o subject)")}
  else if (grepl('not n ?.*', pos)){return("pre-noun")}
  else {return("other")}
}
